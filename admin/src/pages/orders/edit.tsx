...
import { Form, Input, Select, DatePicker, InputNumber, Button, Divider, Checkbox, Row, Col } from "antd";
      ...
      <Edit saveButtonProps={saveButtonProps}>
        <Form {...formProps} onFinish={onFinish} layout="vertical">
          ...
          <Row gutter={16}>
            ...
            <Col span={6}>
              <Form.Item label="Delivery Price" name="delivery_price">
                <InputNumber style={{ width: "100%" }} />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item label="Stand Levels" name="stand_layers">
